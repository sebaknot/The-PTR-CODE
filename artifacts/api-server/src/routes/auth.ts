...
router.post("/auth/send-otp", otpRequestLimiter, async (req: Request, res: Response): Promise<void> => {
...
router.post("/auth/verify-otp", otpVerifyLimiter, async (req: Request, res: Response): Promise<void> => {
...
router.post("/auth/google", authProviderLimiter, async (req: Request, res: Response): Promise<void> => {
...
router.post("/auth/apple", authProviderLimiter, async (req: Request, res: Response): Promise<void> => {
